...
Solver1DGui::Solver1DGui(double Xmin, double Xmax, double Xstep, cmplx Binf, cmplx Bsup, double timeStep) : Solver1D(Xmin ,Xmax, Xstep, Binf, Bsup, timeStep), QMainWindow()
{
